...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/bootstrap.min.js"></script>
        <script type="text/javascript">new Draggable('miVentana4');</script>
        <script>
            // /^[a-zAZ0-9_\.\-]+@[a-zA-Z0-9\-]+
...
<li class="active"><a href="">Nueva Compra Interna</a></li>
      ...
      /*      function erase(id)
         ...
         /*   function tomaralcarro()
            ...
            // aqui mequede checar base de datos de la entrada del provee
                function ru() {
                var pro = $('#tipos').val();
        ...
        <div id="miVentana" style="position: fixed; width: 25%; height: 30%; top: 0; left: 0; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; background-color: #FAFAFA; color: white; display:none;">
            <div class="row " style="background-color: #616185;padding-left: 2%;padding-right: 2%;border-radius: 10px;">
               ...
               <form action="../Vent" method="get" name="formas">
                    ...
                    <input type=text name=cant id="cantis"  class="form-control input-sm chat-input" placeholder=Cantidad required> <br><br>
                    <div align="center" >
