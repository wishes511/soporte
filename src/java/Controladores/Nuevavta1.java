 ...
 * @author mich
 */
@WebServlet(name = "Nuevavta1", urlPatterns = {"/Nuevavta1"})
public class Nuevavta1 extends HttpServlet {
...
//i_d
    ...
    if (usuario != null && tipos != null && tipos.equals("USUARIO")) {
        ...
        c.setNombre("VENTA_PISO");
        c.setApellido("VENTA_PISO");
        c.setCalle("VENTA_PISO");
        c.setColonia("VENTA_PISO");
        ...
        try {
            ...
            PrintWriter out = response.getWriter();
                ...
                out.println("alert('No hay Productos en el Carro de compras !!');");
        ...
        if (cont == 3) {
          ...
          cont =0;
           ...
           db.modificarstock(lista);
            ...
            PrintWriter out = response.getWriter();
                out.println("<script type=\"text/javascript\">");
               // out.println("alert('Venta Realizada !!');");
                out.println("location='usuario/Realizar_ventas.jsp';");
                out.println("</script>");
