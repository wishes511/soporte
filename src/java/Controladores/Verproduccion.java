 ...
 * @author mich
 */
@WebServlet(name = "Verproduccion", urlPatterns = {"/Verproduccion"})
public class Verproduccion extends HttpServlet {
...
//i_d
    ...
    if (usuario != null && tipos != null && tipos.equals("ADMIN")) {
        ...
        DB bd = new DB();
          bd.buscarproduccion(f1, f2);
                    System.out.println("llega");
          
            
            response.sendRedirect("admin/Ver_produccion.jsp");
...
//             response.sendRedirect("Ver_produccion.jsp");
            out.println("<script type=\"text/javascript\">");
            out.println("alert('Surgio un error verificalo');");
            out.println("location='admin/Ver_produccion.jsp';");
            out.println("</script>");
//                PrintWriter out = response.getWriter();
//            out.println("<script type=\"text/javascript\">");
