 ...
 * @author mich
 */
@WebServlet(name = "Borrarproveedor", urlPatterns = {"/Borrarproveedor"})
public class Borrarproveedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            DB udb = new DB();
            udb.eliminarproveedor(Integer.parseInt(id));
            ...
            out.println("alert('No puedes borrar a un Proveedor que ya ha realizado una operacion :(');");
